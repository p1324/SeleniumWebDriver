...
public class TendablechallengeTest {
	...
	public void verifyErrorMessage() throws InterruptedException {
		...
		driver.findElement(By.xpath("//form[@id='contactMarketingPipedrive-163701']//input[@id='form-input-organisationName']")).sendKeys("Infosys");
		driver.findElement(By.xpath("//form[@id='contactMarketingPipedrive-163701']//input[@id='form-input-cellPhone']")).sendKeys("5765786876");
		driver.findElement(By.xpath("//form[@id='contactMarketingPipedrive-163701']//input[@id='form-input-email']")).sendKeys("Pradip@gmail.com");		
		Thread.sleep(10000);
		  WebElement dropDown =driver.findElement(By.xpath("(//select[@id='form-input-jobRole'])[1]"));
		  Select s = new Select(dropDown); s.selectByValue("CNO");
		 WebElement element = driver.findElement(By.xpath("//form[@id='contactMarketingPipedrive-163701']//label[contains(text(),'I Agree')]"));
	    element.click();
